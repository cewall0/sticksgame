...
// Chad Wallace
// March 2021
// This is the game class to make the sticks game object.
...
namespace SticksGame
{
    public class AI
    {
        ...
        public AI(int totalNumSticks)
        {
            ...
            for (int i = 0; i < totalNumHats; i++)          // all hats initially hold one '1', one '2', and one '3' ball.
            {
                hats.Add("123");                            // Always one of each type of ball.
            } // end for
            besideHat = new char[totalNumHats];             // initalize the beside spots for "next" to each hat.
        ...
        public void PutBesideInHats()
        {
            ...
            for (int numHat = 1; numHat < totalNumHats; numHat++)
            {
                ...
                if (thisBesideBall != '0')
                {
                    // put this ball beside the hat + one more all together
        ...
        {
            // Cycle through every hat. We iuse totalNumHats -1 because totalNumHats includes the zero hat.
            for (int numHat = 1; numHat <= totalNumHats - 1; numHat++)
            {
                string theseHatBalls = GetHatBalls(numHat);  // theseHatBalls are the balls in the hat.
